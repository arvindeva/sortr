...
--> statement-breakpoint
ALTER TABLE "sessionFiles" ADD CONSTRAINT "sessionFiles_sessionId_uploadSessions_id_fk" FOREIGN KEY ("sessionId") REFERENCES "public"."uploadSessions"("id") ON DELETE cascade ON UPDATE no action;